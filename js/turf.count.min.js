...
var inside=require("turf-inside");module.exports=function(e,r,t,i){for(var s=0;s<e.features.length;s++){var a=e.features[s];a.properties||(a.properties={});for(var u=0,f=0;f<r.features.length;f++){var n=r.features[f];inside(n,a)&&u++}a.properties[t]=u}return e};

},{"turf-inside":2}],2:[function(require,module,exports){
...
module.exports={count:require("turf-count")};
},{"turf-count":1}]},{},[3])(3)
});